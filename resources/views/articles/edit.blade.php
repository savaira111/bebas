<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-white leading-tight">Edit Artikel</h2>
    </x-slot>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 bg-[#212844] p-6 rounded-2xl shadow text-white">
                        ...
                        <textarea id="content"
                                  name="content"
                                  rows="12"
                                  class="w-full px-4 py-2 rounded-lg bg-white text-black border border-gray-300">{{ old('content', $article->content) }}</textarea>
                    </div>
